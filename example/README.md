# Sync & prune safety — worked example
...
|-------|---------------|:-----:|:--------:|-------------|
| **L0** Bootstrap | your argocd-apps values | ✓ | ✓ | `Prune=confirm`, `Delete=confirm` |
| **L1** Provisioning | tenant-chart default | ✓ | ✓ | `Prune=confirm`, `Delete=confirm` |
| **L2** App-of-apps | tenant-chart default | ✓ | — | `PruneLast=true` |
| **L3** Leaf | your argocd-apps values | ✓ | ✓ | — |
| **L4** Data | resource annotation | — | — | `Prune=false[,Delete=false]` |
