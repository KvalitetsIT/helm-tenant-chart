...
| adminNamespace | string | "" | Injected by the tenant chart. The tenant admin namespace - used to guard against a project namespace.name colliding with the admin namespace at sync time. |
