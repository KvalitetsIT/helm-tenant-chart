...
| projects.\<project-name>.kyvernoPolicyExceptions | object | `{"enabled":true,"exceptions":{"drop-all-capabilities":{"matchConditions":[{"expression":"object.metadata.namespace == '<tenant>-<project>'","name":"match-project-namespace"}],"policyRefs":[{"kind":"ValidatingPolicy","name":"drop-all-capabilities"}]},"require-ro-rootfs":{"enabled":false,"matchConditions":[{"expression":"object.metadata.namespace == '<tenant>-<project>'","name":"match-project-namespace"}],"policyRefs":[{"kind":"ValidatingPolicy","name":"require-ro-rootfs"}]}}}` | Optional. Kyverno PolicyException resources for this project. Overrides or extends `projectDefaults.kyvernoPolicyExceptions`. Resource names are prefixed with the project namespace (`<tenant>-<project>`). See https://kyverno.io/docs/guides/exceptions/ for details. |
| projects.\<project-name>.kyvernoPolicyExceptions.exceptions.require-ro-rootfs.enabled | bool | `false` | Set enabled: false to temporarily disable an exception without removing it. |
